---
title: "ME114 Day 4: Solutions for Applied Exercises on Linear Regression"
author: "Ken Benoit and Slava Mikhaylov"
output: html_document
bibliography: ../bibliography/bibliography.bib
---

Detailed description of the exercises is provided in @james2013 [pp. 121-126]. 
...
# Part (d): verify that these two regressions give the same t-statistic
fit_x_to_y <- lm(x ~ y)
summary(fit_x_to_y)
fit_y_to_x <- lm(y ~ x)
summary(fit_y_to_x)
